	...
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" DataMember="MasterView" Width="100%" AllowAutoHide="false">
		<Template>
			...
			<px:PXPanel runat="server" ID="PnlCust1" Caption="Proforma Invoice" RenderStyle="Fieldset">
				...
				<px:PXCheckBox runat="server" ID="chkEnableJournalEnhance" DataField="EnableJournalEnhance"></px:PXCheckBox></px:PXPanel>
			...
			<px:PXCheckBox runat="server" ID="CstPXCheckBox5" DataField="EnableProdCostAnlys" AlignLeft="True" ></px:PXCheckBox></Template>
