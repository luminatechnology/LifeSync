...
ValidateRequest="false" CodeFile="LM209000.aspx.cs" Inherits="Page_LM209000" Title="Untitled Page" %>

<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" TypeName="LumCustomizations.Graph.InternalCostModelMaint" PrimaryView="ProdItemRecords" Visible="True" BorderStyle="NotSet">
        <CallbackCommands>
    ...
    <Template >
        <px:PXFormView ID="outsideProcessingform" runat="server" CaptionVisible="False" DataMember="OutsideProcessingOperationSelected" DataSourceID="ds" 
            ...
            <Template>
                ...
                <px:PXSelector ID="edPOOrderNbr" runat="server" DataField="POOrderNbr" />
